<template>
    <div class="cameraOptions">
        ...
        <div class="icon">
            <button class="plus" @click="JmolScript('zoomto;')"></button>
            <button class="line" @click="JmolScript('zoomto OUT;')"></button>
        </div>
    </div>
</template>
<script>
